...
echo '<script language="javascript">alert("Hubungi Admin untuk melakukan top up saldo!"); 
...
<title>Halaman depan | E-Kantin</title>
...
<div class="d-flex justify-content-between align-items-center">
<a href="beli-produk.php?id=<?php echo $id ?>"><button type="button"
class="btn btn-outline-success me-2 px-4">Detail</button></a>
